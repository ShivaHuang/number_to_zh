...
describe NumberToCn do
  ...
  it "should go works for 20003" do
    (20003.to_cn_words).should eq("二萬零三")
  end

  it "should go works for 200003" do
    (200003.to_cn_words).should eq("二時萬零三")
  end
  ...
  it "worked for 0.0" do
    (0.0.to_cn_words).should eq("零點零")
  end

  it "worked for 0.003" do
    (0.003.to_cn_words).should eq("零點零零三")
  end

  it "worked for 0.0" do
    (0.02.to_cn_words).should eq("零點零二")
  end

  it "worked for float" do
    ((33.0).to_cn_words).should eq("三十三點零")
  end 
